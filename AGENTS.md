...
- Maintain `data/forums.txt` as the source registry and allow automatic source
...
- Generate machine-readable release data (`data/releases.json`) and a static
  GitHub Pages dashboard. `README.md` is a hand-maintained static file and is
